...
<motion.div
      ...
      <motion.div
        ...
        transition={{ duration: 0.6, delay: 1.4 }}
      >
<h2 className="text-4xl font-semibold mb-6 text-center">Novar&apos;s Values</h2>
<div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-secondary">
          
        <motion.div className="p-6 box" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
            <h3 className="text-xl font-bold text-accent">COLLABORATE</h3>
          ...
          <motion.div className="p-6 box" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
            <h3 className="text-xl font-bold text-accent">CREATE</h3>
          ...
          <motion.div className="p-6 box" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
            <h3 className="text-xl font-bold text-accent">INNOVATE</h3>
          ...
          <motion.div className="p-6 box" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
            <h3 className="text-xl font-bold text-accent">EMPOWER</h3>
