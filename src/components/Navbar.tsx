...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full top-0 shadow-md z-50 flex justify-between items-center px-4 py-2">
      {/* Novar Banner */}
      <Link href="/">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 w-full p-4 shadow-md">
